...
# if __name__ == "__main__":
#     try:
#         logger = MultiPurposeLogger("failtest", LogType.REGULAR, LoggerRunMode.LOCAL)
#         for i in range(100):
#             logger.log(f"will be buffered if write fails {i}")
#         logger.close()
#         print("Buffered metrics:", logger.get_metrics())
#     except Exception as e:
